...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <!-- Large Cover Art (Rounded Corners CornerRadius=16 & Cyan Ambient Glow) -->
    <Border Grid.Row="0" CornerRadius="16" HorizontalAlignment="Center" Margin="0,6,0,30">
        <!-- 動的リサイズ用 Style & DoubleAnimation -->
        <Border.Effect>
            <DropShadowEffect Color="#00FFFF" BlurRadius="28" ShadowDepth="0" Opacity="0.55"/>
        </Border.Effect>
        <Border.Background>
