...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <!-- Large Cover Art (Rounded Corners CornerRadius=16) -->
    <Border Grid.Row="0" CornerRadius="16" Background="{DynamicResource ControlBackgroundBrush}" HorizontalAlignment="Center" ClipToBounds="True" Margin="0,0,0,10">
