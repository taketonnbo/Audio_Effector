...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <!-- Player Pod Card (Semi-transparent Container grouping Current Track & Controls: Vertically elongated) -->
    <Border Grid.Row="2" Background="{DynamicResource ControlBackgroundBrush}" BorderBrush="{DynamicResource BorderBrush}" BorderThickness="1" CornerRadius="12" Padding="16,14" VerticalAlignment="Top">
        <Grid>
            <Grid.RowDefinitions>
...
#### ② 右カラム: 独立した角丸長方形コンテナ ＆ Playlistヘッダー ＆ ゼブラトラックリスト
```xml
<Border Grid.Column="1" Background="{DynamicResource ControlBackgroundBrush}" BorderBrush="{DynamicResource BorderBrush}" BorderThickness="1" CornerRadius="12" Padding="16,14">
    <Grid>
        <Grid.RowDefinitions>
        ...
        <!-- Scrollable Tracklist with High-Contrast Zebra Striping -->
        <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Disabled">
            <ItemsControl ItemsSource="{Binding PlaybackListTracks}" AlternationCount="999" HorizontalContentAlignment="Stretch">
                <!-- DataTemplate with IndexToZebraBackgroundConverter & Inline Status Icons -->
            </ItemsControl>
        </ScrollViewer>
    </Grid>
</Border>
