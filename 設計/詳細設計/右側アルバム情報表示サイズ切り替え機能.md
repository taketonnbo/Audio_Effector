...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <!-- Large Cover Art (Subtle Rounded Corners CornerRadius=8, 3px Thick Metallic Border Frame & Deep Dynamic Shadow) -->
    <Border Grid.Row="0" CornerRadius="8" HorizontalAlignment="Center" Margin="0,6,0,30"
            BorderBrush="{DynamicResource MetallicCardBorderBrush}" BorderThickness="3"
