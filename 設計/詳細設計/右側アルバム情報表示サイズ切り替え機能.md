...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <!-- Player Pod Card (Metallic Gradient Container with Top-Left Light and Bottom-Right Dark) -->
    <Border Grid.Row="2" Background="{DynamicResource MetallicCardBackgroundBrush}" BorderBrush="{DynamicResource MetallicCardBorderBrush}" BorderThickness="1" CornerRadius="12" Padding="16,14" VerticalAlignment="Top">
        <Border.Effect>
        ...
        <Grid>
            <Grid.RowDefinitions>
                ...
                <RowDefinition Height="Auto"/> <!-- Row 1: Quick Actions (Queue, Add to Playlist, Favorite - Right Aligned) -->
