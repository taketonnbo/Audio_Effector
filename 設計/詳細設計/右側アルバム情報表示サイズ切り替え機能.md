...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <Border Grid.Row="0" CornerRadius="16" HorizontalAlignment="Center" Margin="0,6,0,16">
    ...
    <!-- Album Info (Album Name, Artist & Clean Hi-Res Badge) -->
    <StackPanel Grid.Row="1" Margin="4,0,4,10">
        <TextBlock Text="{Binding PlaybackListName, FallbackValue='No Album Selected'}" FontSize="16" FontWeight="Bold" Foreground="{DynamicResource TextForegroundBrush}" FontFamily="Segoe UI" TextTrimming="CharacterEllipsis"/>
        <TextBlock Text="{Binding PlaybackListSubtitle, FallbackValue=''}" FontSize="12" Foreground="{DynamicResource SecondaryTextForegroundBrush}" Margin="0,2,0,0" TextTrimming="CharacterEllipsis"/>
    ...
    <Border Grid.Row="2" Background="{DynamicResource ControlBackgroundBrush}" BorderBrush="{DynamicResource BorderBrush}" BorderThickness="1" CornerRadius="12" Padding="14,10" VerticalAlignment="Top">
        <Grid>
            <Grid.RowDefinitions>
                ...
                <RowDefinition Height="Auto"/> <!-- Playback Control Buttons (Prominent Play Button) -->
                <RowDefinition Height="Auto"/> <!-- Seekbar & Timestamps -->
            </Grid.RowDefinitions>
            <!-- 楽曲名 & クイックアクション (Fav/Playlist/Queue) -->
            <!-- センターフォーカス再生ボタン (直径38px シアン円形) & スキップ/シャッフル/リピート -->
            <!-- ワイドシークバー -->
        </Grid>
    </Border>
</Grid>
...
<Border Grid.Column="1" Background="{DynamicResource ControlBackgroundBrush}" BorderBrush="{DynamicResource BorderBrush}" BorderThickness="1" CornerRadius="12" Padding="16,14">
    <Grid>
        ...
        <!-- Playlist Header -->
        <Grid Grid.Row="0" Margin="0,0,30,12">
            <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                <TextBlock Text="Playlist: " FontSize="15" FontWeight="SemiBold" Foreground="{StaticResource NeonCyanBrush}"/>
                <TextBlock Text="{Binding PlaybackListName, FallbackValue='No Album Selected'}" FontSize="15" FontWeight="Bold" Foreground="{DynamicResource TextForegroundBrush}" TextTrimming="CharacterEllipsis" MaxWidth="320"/>
            </StackPanel>
            <TextBlock Text="{Binding PlaybackListTracksCountText}" FontSize="12" Foreground="{DynamicResource MutedTextForegroundBrush}" HorizontalAlignment="Right" VerticalAlignment="Center"/>
        </Grid>
