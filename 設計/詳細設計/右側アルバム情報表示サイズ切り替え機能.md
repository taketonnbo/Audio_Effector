...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <!-- Player Pod Card (Semi-transparent Container grouping Current Track & Controls) -->
    <Border Grid.Row="2" Background="{DynamicResource ControlBackgroundBrush}" BorderBrush="{DynamicResource BorderBrush}" BorderThickness="1" CornerRadius="12" Padding="14,10" VerticalAlignment="Top">
        <Grid>
            <Grid.RowDefinitions>
                <RowDefinition Height="Auto"/> <!-- Current Track Title & Quick Actions -->
                <RowDefinition Height="Auto"/> <!-- Playback Control Buttons (Prominent 48px Play Button) -->
                <RowDefinition Height="Auto"/> <!-- Seekbar & Timestamps -->
            </Grid.RowDefinitions>
            <!-- 楽曲名 & クイックアクション (Fav/Playlist/Queue) -->
