...
<Grid Grid.Column="0" Margin="0,0,20,0">
    ...
    <!-- Large Cover Art (Subtle Rounded Corners CornerRadius=6, Metallic Border & Deep Ambient Shadow) -->
    <Border Grid.Row="0" CornerRadius="6" HorizontalAlignment="Center" Margin="0,6,0,30"
            BorderBrush="{DynamicResource MetallicCardBorderBrush}" BorderThickness="1">
        <Border.Style>
            <!-- DoubleAnimation (Width/Height 260px ⇔ 330px with CubicEase) -->
        </Border.Style>
        <Border.Effect>
            <DropShadowEffect Color="#000000" BlurRadius="22" ShadowDepth="6" Direction="270" Opacity="0.45"/>
        </Border.Effect>
        <Border.Background>
