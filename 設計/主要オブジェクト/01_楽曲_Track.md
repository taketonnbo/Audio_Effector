...
>   現状、楽曲の一覧（コレクション）は以下の3箇所に限定して表示されています：
...
| プロパティ名 | 型 | 説明 | 現状のコレクション表示 | 現状のシングル表示 | 実装プロパティ ([Track.cs](file:///c:/Users/tnish/vs_code_git/Audio_Effector/AudioEffector/Domain/Entities/Track.cs)) |
| :--- | :--- | :--- | :---: | :---: | :--- |
